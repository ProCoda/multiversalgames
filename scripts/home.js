...
function rightArrowClick(){
    ...
    if(sectionIndex > 3){ sectionIndex = 0; } //Check if sectionIndex is more than 3 because only 4 elements in carosuel. If it is more than 3 than set to 0.
...
function leftArrowClick(){
    ...
    if(sectionIndex < 0){ sectionIndex = 3; } //Check if sectionIndex is less than 0 because section index cannot be negative. If so than set to 3.
